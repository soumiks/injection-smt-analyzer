...
def _cmd_analyze(args) -> int:
    ...
    if mode == "legacy" or benchmark_id in ("undici_crlf", "django_sql", "log4j_jndi", "spring4shell", "laravel_ignition", "handlebars_lookup", "nodemailer_sendmail", "pug_pretty", "json5_proto", "yargs_parser", "axios_ssrf"):
...
def _legacy_analyze(benchmark_id: str, rev: str, mode: str, output: str) -> int:
    ...
    if benchmark_id == "axios_ssrf":
        from isa.benchmarks.axios_ssrf_proof import prove_witness
